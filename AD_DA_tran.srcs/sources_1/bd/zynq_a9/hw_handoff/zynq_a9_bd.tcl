...
################################################################
# This is a generated script based on design: zynq_a9
#
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set GPIO_I_1 [ create_bd_port -dir I -from 43 -to 0 GPIO_I_1 ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_GPIO_EMIO_GPIO_WIDTH {44} \
  ...
  connect_bd_net -net GPIO_I_0_1 [get_bd_ports GPIO_I_1] [get_bd_pins processing_system7_0/GPIO_I]
