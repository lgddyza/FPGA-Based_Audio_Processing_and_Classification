...
module FFT_OUT(
    ...
    wire [11:0] index;
    wire [7:0]  third_harmonic;
    wire [7:0]  second_harmonic;
    wire [11:0]  peak_power;

//--------------------------------------------------
// 将voice, music, range_mode, max信号打包成4位向量连接到EMIO
//--------------------------------------------------
wire [43:0] pl_to_ps_signals;

assign pl_to_ps_signals[0] = voice;  // EMIO引脚54
assign pl_to_ps_signals[1] = music;  // EMIO引脚55  
assign pl_to_ps_signals[2] = range_mode;   // EMIO引脚56
assign pl_to_ps_signals[3] = max;    // EMIO引脚57
assign pl_to_ps_signals[15:4] = index;  // EMIO引脚58-69
assign pl_to_ps_signals[23:16] = third_harmonic;  // EMIO引脚70-77
assign pl_to_ps_signals[35:24] = peak_power;  // EMIO引脚78-89 
assign pl_to_ps_signals[43:36] = second_harmonic;  // EMIO引脚90-97
...
zynq_a9_wrapper zynq_a9_wrapper_i (
    ...
    .GPIO_I_1            (pl_to_ps_signals)  // 44位信号向量
);
