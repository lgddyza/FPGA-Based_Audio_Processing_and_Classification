...
set cached_ip [config_ip_cache -export -no_bom -use_project_ipc -dir F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.runs/ila_2_synth_1 -new_name ila_2 -ip [get_ips ila_2]]

if { $cached_ip eq {} } {
close [open __synthesis_is_running__ w]

synth_design -top ila_2 -part xc7z020clg400-2 -mode out_of_context
...
if { [catch {
  file copy -force F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.runs/ila_2_synth_1/ila_2.dcp F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.runs/ila_2_synth_1/ila_2_stub.v F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.runs/ila_2_synth_1/ila_2_stub.vhdl F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.runs/ila_2_synth_1/ila_2_sim_netlist.v F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.runs/ila_2_synth_1/ila_2_sim_netlist.vhdl F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.ip_user_files/ip/ila_2]} {
  catch { 
    file copy -force F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_stub.v F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.ip_user_files/ip/ila_2
  }
}

if {[file isdir F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.ip_user_files/ip/ila_2]} {
  catch { 
    file copy -force F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.srcs/sources_1/ip/ila_2/ila_2_stub.vhdl F:/FPGA/work_space/AD_DA_tran/AD_DA_tran.ip_user_files/ip/ila_2
  }
}
