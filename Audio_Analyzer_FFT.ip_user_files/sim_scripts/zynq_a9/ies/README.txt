...
#
# Generated by export_simulation on Wed Nov 05 21:51:00 +0800 2025
#
################################################################################
...
'-reset_run' switch to the './zynq_a9.sh' script.

./zynq_a9.sh -reset_run
...
./zynq_a9.sh -noclean_files

For more information on the script, please type './zynq_a9.sh -help'.
